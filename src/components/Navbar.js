              ...
              {showNotifications && (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ borderBottom: '1px solid #eee', backgroundColor: 'var(--peach-base)' }}
                  >
                    <span style={{ fontWeight: '600', color: 'var(--text-dark)' }}>Notifications</span>
                    {unreadCount > 0 && (
                      <span
                        onClick={markAllAsRead}
                        style={{ fontSize: '0.75rem', cursor: 'pointer', color: 'var(--peach-dark)', fontWeight: '500' }}
                      >
                        Mark all as read
                      </span>
                    )}
                  ...
                  <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                    {notifications.length === 0 ? (
                      <div className="text-center text-muted p-3" style={{ fontSize: '0.875rem' }}>
                        No notifications
                      </div>
                    ) : (
                      notifications.map(n => (
                        ...
                        >
                          ...
                          <div style={{ fontSize: '0.75rem', color: '#999', marginTop: '2px', paddingLeft: n.read ? '0' : '16px' }}>
                            {n.time}
                          </div>
                        </div>
                      ))
